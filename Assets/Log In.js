...
{
    let customerid = "Chocospark";
    let customerpassword = "chocospark@123";   
    let adminid = "ChocosparkAdmin";
    let adminpassword = "chocospark@123admin";
    loginbutton.onclick = function() {
    if(idinput.value === customerid && passwordinput.value === customerpassword){
        window.location.href = 'index.html';
    }
    else if(idinput.value === adminid && passwordinput.value === adminpassword) {
